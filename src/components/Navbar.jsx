...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex justify-between items-center w-full h-20 px-4 text-white fixed bg-black">
       <div><h1 className="text-3xl  ml-2">Portfolio</h1></div>
       <ul className="hidden md:flex">
       {
           links.map(({id,link})=>(
           
            <li key={id} className="px-4 text-xl cursor-pointer capitalize font-medium text-gray-500 hover:scale-105 duration-200">
